...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private float m_followOffset = 0f;//The x position offset of the camera follow position
        [SerializeField] private float m_followHeight = 2f;//The y position offset of the camera follow position
        [SerializeField] private float m_followDistance = -2f;//The z position offset of the camera follow position
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position, m_Target.position + m_Target.transform.right * m_followOffset + m_Target.transform.forward * m_followDistance + m_Target.transform.up * m_followHeight, deltaTime*m_MoveSpeed);
